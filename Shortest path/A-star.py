...
def algorithm(draw, grid, start, end):
    ...
    f_score[start] = distanceManhattan(start.get_pos(), end.get_pos())
    ...
    while not open_set.empty():
        ...
        for neighbor in current.neighbors:
            ...
            if temp_g_score < g_score[neighbor]:
                ...
                f_score[neighbor] = temp_g_score + distanceManhattan(neighbor.get_pos(), end.get_pos())
